...
function EnvelopePage({ guestName }: { guestName: string | null }) {
    ...
    async function openEnvelope() {
        ...
        // Trigger music on envelope open
        if (typeof window !== 'undefined' && (window as any).__playMusic) {
    ...
    return (
        ...
        >
            ...
            <img src="/bunga-4.png" alt="" style={{
                position: 'absolute', width: 279, height: 279,
                left: -72, top: 226, transform: 'rotate(-11deg)',
                pointerEvents: 'none', zIndex: 0,
            }} />

            {/* bunga 3 — bottom right */}
            <img src="/bunga-3.png" alt="" style={{
                position: 'absolute', width: 137, height: 137,
                right: -10, bottom: 200, transform: 'rotate(-6deg)',
            ...
            <div style={{ perspective: '600px', perspectiveOrigin: '50% 60%', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{
                    position: 'relative', width: EW, height: EH + 200,
                    transformStyle: 'preserve-3d', marginTop: -100
                }}>
                    ...
                    <motion.div
                        ...
                        style={{
                            ...cardBase,
                            background: '#F3E9D3', border: '1px solid #C1B0A1',
                            left: '50%', marginLeft: -cardBase.width / 2,
                            opacity: 0, z: 0, transformStyle: 'preserve-3d',
                            boxShadow: '0 16px 48px rgba(0,0,0,0.45)',
                            cursor: ready ? 'pointer' : 'default', zIndex: 20,
                        }}
                        animate={card1Ctrl}
                        onClick={(e) => { e.stopPropagation(); selectCard('invitation', card1Ctrl, card2Ctrl) }}
                        whileHover={{}}
                    >
                    ...
                    <motion.div
                        ...
                        style={{
                            ...cardBase,
                            background: '#CFD9BF', border: '1px solid #C1B0A1',
                            left: '50%', marginLeft: -cardBase.width / 2,
                            opacity: 0, z: 0, transformStyle: 'preserve-3d',
                            boxShadow: '0 16px 48px rgba(0,0,0,0.45)',
                            cursor: ready ? 'pointer' : 'default', zIndex: 20,
                        ...
                        animate={card2Ctrl}
                        onClick={(e) => { e.stopPropagation(); selectCard('gallery', card2Ctrl, card1Ctrl) }}
                        whileHover={{}}
                    >
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            style={{ width: EW, height: FLAP_H, bottom: EH - FLAP_H, transformOrigin: 'top center', zIndex: 4 }}
                            animate={flapCtrl}
                        >
                        ...
                        <motion.div
                            className="absolute"
                            style={{ width: 56, height: 56, left: '50%', marginLeft: -28, bottom: EH - FLAP_H - 20, zIndex: 6 }}
                            animate={sealCtrl}
                        >
                ...
                >
                    ...
                    <p className="font-body italic text-xs mt-4" style={{ color: '#354B39', opacity: 0.5, fontSize: 11, letterSpacing: 1 }}>
                        Undangan ini bersifat pribadi.<br />Mohon untuk tidak meneruskan link ini.
                    </p>
                </motion.div>
